...
get_required_kitsune_lib_repo "libKitsunemimiCommon" "v0.21.0" 4 "staticlib"

#-----------------------------------------------------------------------------------------------------------------

if [ $1 = "test" ]; then
    build_kitsune_lib_repo "libKitsunemimiCpu" 4 "staticlib run_tests"
else
    build_kitsune_lib_repo "libKitsunemimiCpu" 4 "staticlib"
fi
